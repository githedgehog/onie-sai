        ...
        if let Some(arg0_basename) = std::path::Path::new(&arg0).file_name() {
            ...
            if let Some(arg0_basename_str) = arg0_basename.to_str() {
                ...
                match arg0_basename_str {
                    "onie-saictl" | "onie-lldpctl" => return onie_lldpctl::main(),
                    "onie-said" | "onie-lldpd" => return onie_lldpd::main(),
...
fn main_default() -> anyhow::Result<()> {
    ...
    let arg0 = arg0
        ...
        .unwrap_or("[none]");
    anyhow::bail!(
        "unsupported app \"{arg0}\", supported apps are \"onie-lldpctl\" (\"onie-saictl\") and \"onie-lldpd\" (\"onie-said\")"
    )
}
